...
TEST(SistemaTest, Tres_particulas_con_las_fuerzas_de_peso_posicionadas_en_forma_de_piramide_las_de_abajo_se_mueven_para_los_costados_y_la_de_arriba_cae)
{
    ...
    Particula_pos *particula2 = new Particula_pos(1.0f, Vector2(.0f, 1.0f), Vector2(.0f, .0f), Vector2(.0f, -10.0f));
    Particula_pos *particula3 = new Particula_pos(1.0f, Vector2(.2f, .0f), Vector2(.0f, .0f), Vector2(.0f, -10.0f));
    Particula *piso = new Particula();
