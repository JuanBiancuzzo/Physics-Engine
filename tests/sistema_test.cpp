...
TEST(SistemaTest, Dos_particulas_y_el_piso_sin_velocidad_ninguna_sus_fuerzas_finales_son_cero)
{
    ...
    ParticulaDinamica particula1 = ParticulaDinamica({&cuerpo1, 1.0f, 1.0f});
    atributo::Fuerza fuerza1(Vector2(.0f, -10.0f));
    particula1.agregar_atributo(fuerza1);

    cr::Circulo cuerpo2(Vector2(.0f, 1.0f), .0f, 1.0f);
    ParticulaDinamica particula2 = ParticulaDinamica({&cuerpo2, 2.0f, 1.0f});
    atributo::Fuerza fuerza2(Vector2(.0f, -20.0f));
    particula1.agregar_atributo(fuerza1);
    ...
    sistema.expandir_interacciones(1.0f);
...
//     Particula *particula1 = new Particula_pos(1.0f, Vector2(.0f, -10.0f), Vector2(.0f, -10.0f), 1.0f);
//     Particula *particula2 = new Particula_pos(2.0f, Vector2(), Vector2(.0f, -20.0f), 1.0f);
...
//     sistema.expandir_interacciones(1f);
...
//     Particula *particula2 = new Particula_pos(1.0f, Vector2(), Vector2(.0f, -10.0f), 1.0f);
//     Particula *piso = new Particula_pos();
